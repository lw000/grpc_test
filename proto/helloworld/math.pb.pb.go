...
func (*AddRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7044babab56fa5b, []int{0}
}
...
func (*AddReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7044babab56fa5b, []int{1}
}
...
func (*SubRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7044babab56fa5b, []int{2}
}
...
func (*SubReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7044babab56fa5b, []int{3}
}
...
func init() { proto.RegisterFile("math.pb", fileDescriptor_d7044babab56fa5b) }

var fileDescriptor_d7044babab56fa5b = []byte{
